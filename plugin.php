...
define( 'WPCRAWLER_PLUGIN_FILENAME', plugin_dir_path( __FILE__ ) ); // Filename of the plugin, including the file.
...
require_once WPCRAWLER_PLUGIN_FILENAME . 'vendor/autoload.php';
